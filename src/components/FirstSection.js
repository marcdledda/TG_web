    ...
    render(){
        return(
            <div className="container">
                <div className="py-lg-5 my-5 row align-items-center">
                    ...
                    <div className="theVideo col-sm embed-responsive embed-responsive-16by9">
                        <iframe title="Testing Grounds VR - Teaser" className="embed-responsive-item" src="https://www.youtube.com/embed/L44CEcX4Z78?rel=0" frameBorder="0" allowFullScreen></iframe>
                    </div>
                </div>
            </div>
        );
